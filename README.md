...
forward-kinematics check), then moves: rest, hover, down to 8.5 cm, close, lift to 10 cm off the ground, carry
10 cm to the left, lower, let go, lift away, rest. Tuning flags: `--grip-z`, `--open`, `--jaw-angle`,
